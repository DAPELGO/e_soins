...
class HomeController extends Controller
{
    ...
    public function efiche($id)
    {
        ...
        $examens = Equipement::whereIn('code_examen', $liste_eq)->get();
        return view('esoins.fiche', compact('consult', 'nproducts', 'cproducts', 'actes', 'examens', 'patient', 'quantity_prod', 'quantity_act', 'quantity_eq', 'csps', 'district', 'drs'));
    }
    ...
    public function storeConsultation(Request $request)
    {
        ...
        // COUT EVACUATION
        $cout_evacuation = 0;
        if($request->nbre_kilomettre !=''){
            $cout_evacuation = floatval($request->nbre_kilomettre)*120;
        }
        // dd($liste_ex);
