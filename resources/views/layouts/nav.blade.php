    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
      ...
      <div class="navbar-vertical-content h-100">
        <ul class="navbar-nav flex-column" id="navbarVerticalNav">
            <li class="nav-item">
                <!-- label-->
                <p class="navbar-vertical-label" style="margin-top:0.5rem;">Application</p>
                <hr class="navbar-vertical-line" />
                <!-- parent pages-->
                <div class="nav-item-wrapper @yield('dashboard')">
                    <a class="nav-link label-1 @yield('dashboard')" href="{{ route('home') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <!-- parent pages-->
                <div class="nav-item-wrapper @yield('factures')">
                    <a class="nav-link label-1 @yield('factures')" href="{{ route('app.factures') }}" role="button" data-bs-toggle="" aria-expanded="false">
            ...
            <li class="nav-item">
                ...
                <!-- parent pages-->
                <div class="nav-item-wrapper @yield('user')">
                    <a class="nav-link label-1 @yield('user')" href="{{ route('users.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
