                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @foreach ($typeprestations as $typeprestation)
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="patient_type" id="cible{{ $typeprestation->id }}" required="required" value="{{ $typeprestation->id }}" onclick="changeValue('cible{{ $typeprestation->id }}', 'diagnostic', 'valeur');" />
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="diagnostic" name="diagnostic">
                                    ...
                                    <form class="mb-2 needs-validation" id="wizardValidationForm4" novalidate="novalidate" data-wizard-form="4">
                                        ...
                                        <div id="examens" data-list='{"valueNames":["examen","price_examen","category_examen","tags_examen","vendor_examen","time_examen"],"page":10,"pagination":true}'>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-auto col-6">
                                                    <div class="total panel-title" style="padding: 0.1rem 1rem;"><span>MONTANT TOTAL : </span><strong class="badge badge-light-primary rounded-pill" id="total_account_examen" style="font-size: 1.2rem;">0</strong></div>
                                                </div>
                                            </div>
                                            </div>
                                            <div class="bg-white border-top border-bottom border-200 position-relative top-1" style="height: 24rem; max-height: 24rem; overflow:scroll">
                                            <div class="table-responsive scrollbar mx-n1 px-1">
                                                ...
                                                <thead>
                                                    ...
                                                    <th class="sort align-middle ps-3" scope="col" data-sort="tags_examen" style="width:50px;">TOTAL</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="list" id="examens-table-body">
                                                    ...
                                                    <td class="examen align-middle ps-1">{{ $examen->description }}</td>
                                                    <td class="price_examen align-middle white-space-nowrap text-end fw-bold text-700">
                                                        <input class="form-control @error('quantity_examen') is-invalid @enderror form-control-sm" id="quantity_examen{{ $examen->id }}" name="quantity_examen{{ $examen->id }}" type="number" value="{{ old('quantity_examen') ? old('quantity_examen') : 0 }}" style="width: 5rem;" disabled onclick="setPrice({{ $examen->id }}, 'examen');" onkeyup="setPrice({{ $examen->id }}, 'examen');" />
                                                        @error('quantity_examen')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </td>
                                                    <td class="category_examen align-middle white-space-nowrap text-600 fs--1 ps-1 fw-semi-bold"><span class="badge badge-tag me-2 mb-2" id="price_examen{{ $examen->id }}">{{ $examen->prix_pvp }}</span></td>
                                                    <td class="tags align-middle review pb-2 ps-3"><a class="text-decoration-none" href="#!"><span id="total_examen{{ $examen->id }}" class="badge badge-tag me-2 mb-2">0.00</span></a>
                                                    </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div id="show_mise_observation" style="display: none;">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control input-border-bt" id="nbre_jours" type="number" name="nbre_jours" />
                                                </div>
                                                <div class="mb-3">
