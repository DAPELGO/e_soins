  ...
  const wizardInit = () => {
    ...
    wizards.forEach(wizard => {
      ...
      nextButton.addEventListener(events.CLICK, () => {
        ...
        document.getElementById("cout_global_examen").innerText = total_account_examen;
        document.getElementById("cout_global_observation").innerText = observation_montant;
        document.getElementById("cout_global_evacuation").innerText = evacuation_montant;
