...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function() {
      ...
      Route::post('/factures/store', [eSoinsController::class, 'storeFacture'])->name('esoins.store');
      Route::post('/factures/store_all', [eSoinsController::class, 'storeAllFacture'])->name('esoins.store_all');
